...
thetaPlantArray = [theta_p(5);theta_p(6)];
...
for kk = 1:nEnd
    ...
    if kk > Ne && rem(kk,dRTO_exec) == 0
        ...
        if ma(1) == 1
            ...
            thetaDRTO = [theta_nom(1);theta_nom(2);theta_nom(3);theta_nom(4);theta_m(5);theta_m(6);theta_nom(7)];
        ...
        elseif ma(2) == 1
            ...
            thetaDRTO = [theta_nom(1);theta_nom(2);theta_nom(3);theta_nom(4);thetaHatk(1);thetaHatk(2);theta_nom(7)];
    ...
    thetaPlantArray = [thetaPlantArray, [theta_p(5);theta_p(6)]];
...
function [X_0,U_0,theta_nom,sysBounds] = CSTRModelInitParBounds()
    ...
    % Parameters bounds
    sysBounds.theta_lb = [1.2;
                          -18];   % Psi [rearranged activation energy]

    sysBounds.theta_ub = [1.8;
...
function [solver,MHEbounds,N,Qx,Qtheta,Qy] = MHE(F,theta_nom,dt_sys,dim_sys,sb)
    ...
    for k=0:N-1
        ...
        Yk = X(k+1, :)';
        Uk = U(k+1, :)';
        thetak = [theta_nom(1);theta_nom(2);theta_nom(3);theta_nom(4);Pk{1};Pk{2};theta_nom(7)];
