...
#%% Labels
xLab = ['$C_A$ [mol/m3]','$T$ [K]']
uLab = ['$C_{A,f}$ [mol/m3]','$T_{f}$ [K]','$T^{SP}$ [K]']
...
for ii in range(2): 
    ...
    axs[ii].plot(tgrid,b['XPlantArray'][ii,:],colorMethod[1], label =methodLabel[1],linewidth=2)
    axs[ii].plot(tgrid,a['XPlantArray'][ii,:],colorMethod[0], label =methodLabel[0],linewidth=2)
...
axs[2].plot(tgrid,b['XPlantArray'][3,:],colorMethod[1], label =methodLabel[1],linewidth=2)
axs[2].plot(tgrid,a['XPlantArray'][3,:],colorMethod[0], label =methodLabel[0],linewidth=2)
...
axs[2].grid(visible=True, which='major', linestyle='-')
axs[2].grid(visible=True, axis='x',which='minor',linestyle='-', alpha=0.3)
...
for ii in range(3): 
    ...
    axs[ii].step(tgrid,b['UPlantArray'][ii,:],colorMethod[1], label =methodLabel[1],linewidth=2)
    axs[ii].step(tgrid,a['UPlantArray'][ii,:],colorMethod[0], label =methodLabel[0],linewidth=2)
...
#ax.plot(tgrid, np.array(a['OFPlantArray'].T/a['dt_sys'],ndmin=0),colorMethod[0], label =methodLabel[0], linewidth=2)
#ax.plot(tgrid, np.array(b['OFPlantArray'].T/b['dt_sys'],ndmin=0),colorMethod[1], label =methodLabel[1], linewidth=2)
ax.plot(tgrid, (1 - b['XPlantArray'][0,:]/b['UPlantArray'][0,:]),colorMethod[1], label =methodLabel[1], linewidth=2)
ax.plot(tgrid, (1 - a['XPlantArray'][0,:]/a['UPlantArray'][0,:]),colorMethod[0], label =methodLabel[0], linewidth=2)
...
for ii in range(2): 
    axs[ii].plot(tgrid,a['biasModelArray'][ii,:],markerMethod[0], label =methodLabel[0],linewidth=2)
