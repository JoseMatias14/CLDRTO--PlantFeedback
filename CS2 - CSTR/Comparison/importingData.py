...
# LOADING DATA #
################
a = scipy.io.loadmat('test2_BIAS_2p_un.mat')
b = scipy.io.loadmat('test2_MHE_2p_un.mat')
nData = 2
...
for ii in range(2): 
    axs[ii].plot(tgrid,b['thetaPlantArray'][ii,:],color='k', linestyle=':', label = 'True', linewidth=2)
    axs[ii].plot(tgrid,b['thetaHatArray'][ii,:],markerMethod[1], label = 'Est', markersize=4)
...
for ii in range(2): 
    axs[ii].plot(tgrid,b['XPlantArray'][ii,:],color='k', linestyle=':', label = 'True', linewidth=2)
    axs[ii].plot(tgrid,b['XHatArray'][ii,:],markerMethod[1], label = 'Est', markersize=4)
