...
def CreateColumnModel():
    ...
    dxTopdt =  []
    dxTopdt.append((-x_top[0] + x_A[par['NT'] - 1])/par['tauDelay'])
    dxTopdt.append((-x_top[1] + x_top[0])/5.0)
    dxTopdt.append((-x_top[2] + x_top[1])/5.0)
    # ! end modeling
...
def CreateColumnModelClosedLoop():
    ...
    dxTopdt =  []
    dxTopdt.append((-x_top[0] + x_A[par['NT'] - 1])/par['tauDelay'])
    dxTopdt.append((-x_top[1] + x_top[0])/par['tauDelay'])
    dxTopdt.append((-x_top[2] + x_top[1])/par['tauDelay'])
...
def SystemParameters():
    ...
    # delay time
    tauDelay = 15         # * sampling time = 10 [min]
